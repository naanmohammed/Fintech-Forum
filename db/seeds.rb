...
first_post = Post.create(author: first_user, title: 'Second', text: 'This is my second post')
first_post = Post.create(author: first_user, title: 'Third', text: 'This is my third post')
first_post = Post.create(author: first_user, title: 'Fourth', text: 'This is my fourth post')
...
Comment.create(post: first_post, author: second_user, text: 'Hi Melaku!')
Comment.create(post: first_post, author: second_user, text: 'Hi Samri!')
Comment.create(post: first_post, author: second_user, text: 'Hi Yohannes!')
Comment.create(post: first_post, author: second_user, text: 'Hi Yordi!')
