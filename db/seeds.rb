...
first_user = User.create(name: 'Tom', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Teacher from Mexico.', role: 'admin', email: 'tom@example.com', username:'Tommy', password: '123456')
second_user = User.create(name: 'Lilly', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Teacher from Poland.', email: 'lilly@example.com',username:'Lillou', password: '123456')
third_user = User.create(name: 'Murida', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Teacher from Mexico.', role: 'admin', email: 'murida@example.com', username:'mirud', password: '123456')
